 ...
 <div class="left side-menu">
     ...
     <div class="topbar-left">
         <div class="text-center">
             <a href="" class="logo"><i class="mdi mdi-assistant"></i> Inventory</a>
             ...
             <ul>
                 ...
                 <li class="has_sub">
                     <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-table"></i> <span>
                             Master</span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                     <ul class="list-unstyled">
                         <li><a href="advanced-highlight.html">Marketing</a></li>
                         <li><a href="advanced-rating.html">Produksi</a></li>
                         <li><a href="advanced-alertify.html">Desain</a></li>
